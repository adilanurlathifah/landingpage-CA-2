<template>
  ...
  <footer class="footer">
    ...
    <p style="text-align: center; margin-top: 10px;">© 2023 PT Global Inovasi Siber Indonesia | Powered by <a href="https://www.cyberarmy.id/" style="color: #2361fd;">CyberArmyID</a></p>
  </footer>
</div>
</template>
